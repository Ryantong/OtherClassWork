...
//play around with String.split!
	 ...
	 System.out.println(Arrays.toString("I really like real ly red apples!".split("really")));
...
*/
 ...
 public static String sandwich(String sandwich) {
	 int breadAt = sandwich.indexOf("bread");
	 String outside = sandwich.substring(0, breadAt);
	 String[] name = sandwich.split(outside);
